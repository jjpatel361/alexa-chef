...
Servant.prototype.setSteps = function (cookingSteps) {
    return this.steps = cookingSteps; // Cooking steps is an array of prompt as key
}

Servant.prototype.completed = function() {
  return this.currentStep === (this.steps.length - 1);
};

Servant.prototype.getPrompt = function() {
  return this.getStep().prompt;
};

Servant.prototype.getStep = function() {
